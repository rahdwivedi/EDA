    ...
    with col2:
        ...
        if value_type == "Show as Count":
            ...
            fig_maintenance = px.bar(
                ...
                x='Vehicle_Model',
                y='Maintenance_Count',
                title='Top 10 Vehicle Models by Maintenance Count',
            ...
            fig_maintenance = px.pie(
                ...
                title='Top 10 Vehicle Models by Maintenance (%)',
                hole=0.4
            )
    ...
    with col3:
        ...
        if value_type == "Show as Percentage":
            ...
            fig_accident = px.pie(
                ...
                title='Top 10 Models by Accident History (%)',
                hole=0.4
            )
        else:
            ...
            fig_accident = px.bar(
                ...
                x='Vehicle_Model',
                y='Accident_History',
                title='Top 10 Models by Avg Accident History (Count)',
                color='Vehicle_Model'
            )
